...
Status MakeTimelineKey(int64_t user_id,
                       int64_t ts,
                       uint32_t duration,
                       float gps_longitude,
                       float gps_latitude,
...
Status MakeTimelineValue(int64_t user_id,
                         int64_t ts,
                         uint32_t duration,
                         float gps_longitude,
                         float gps_latitude,
...
Status Pusher::PutTimelineLocation(int64_t user_id,
                                   int64_t ts,
                                   uint32_t duration,
                                   float gps_longitude,
                                   float gps_latitude,
...
Status Pusher::PutReverseLocation(int64_t user_id,
                                  int64_t ts,
                                  uint32_t duration,
                                  float gps_longitude,
                                  float gps_latitude,
...
grpc::Status Pusher::InternalPutLocation(
...
grpc::Status Pusher::InternalDeleteUser(
    grpc::ServerContext* context,
